...
rospack.list()
rospy.init_node('sarc_low_mapROA1', anonymous=True)
...
def sarc_low_mapROA1():
  ...
  f = open(rospack.get_path('sarc_environment') + "/worlds/SARC2.world", "w")
  f.write(startText)
  ...
  for i in range(dronesquant):
      ...
      # print(ydrone[i])
      d = open(rospack.get_path('sarc_environment') + "/starts/start_low_mapROA1/pos/pos" + str(i + 1) + ".yaml", "w")
