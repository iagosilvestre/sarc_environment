...
def callbackdetect_fire_uav3(data):
	...
	ws_lock.release()
pub_dict = { 'detect_fire_uav3' : pubdetect_fire_uav3}
msg_dict = { 'detect_fire_uav3' : "std_msgs/Int8"}
def monitor():
	global pub_error, pub_verdict
	with open(log, 'w') as log_file:
		log_file.write('')
	rospy.init_node('monitor_3', anonymous=True)
	pub_error = rospy.Publisher(name = 'monitor_3/monitor_error', data_class = MonitorError, latch = True, queue_size = 1000)
	pub_verdict = rospy.Publisher(name = 'monitor_3/monitor_verdict', data_class = String, latch = True, queue_size = 1000)
...
def main(argv):
	...
	log = '/home/ctc_das/mrs_workspace/src/log3.txt' 
	actions = {
