...
def callbackdetect_fire_uav2(data):
	...
	ws_lock.release()
pub_dict = { 'detect_fire_uav2' : pubdetect_fire_uav2}
msg_dict = { 'detect_fire_uav2' : "std_msgs/Int8"}
def monitor():
	global pub_error, pub_verdict
	with open(log, 'w') as log_file:
		log_file.write('')
	rospy.init_node('monitor_2', anonymous=True)
	pub_error = rospy.Publisher(name = 'monitor_2/monitor_error', data_class = MonitorError, latch = True, queue_size = 1000)
	pub_verdict = rospy.Publisher(name = 'monitor_2/monitor_verdict', data_class = String, latch = True, queue_size = 1000)
...
def main(argv):
	...
	log = '/home/ctc_das/mrs_workspace/src/log2.txt' 
	actions = {
