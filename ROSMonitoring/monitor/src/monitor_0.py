...
def callbackdetect_fire_uav1(data):
	...
	ws_lock.release()
pubdetect_fire_uav2 = rospy.Publisher(name = 'detect_fire_uav2_mon', data_class = Int8, latch = True, queue_size = 1000)
def callbackdetect_fire_uav2(data):
	global ws, ws_lock
	dict = message_converter.convert_ros_message_to_dictionary(data)
	dict['topic'] = 'detect_fire_uav2'
	dict['time'] = rospy.get_time()
	ws_lock.acquire()
	while dict['time'] in dict_msgs:
		dict['time'] += 0.01
	...
	dict_msgs[dict['time']] = data
	ws_lock.release()
pubdetect_fire_uav3 = rospy.Publisher(name = 'detect_fire_uav3_mon', data_class = Int8, latch = True, queue_size = 1000)
def callbackdetect_fire_uav3(data):
	global ws, ws_lock
	dict = message_converter.convert_ros_message_to_dictionary(data)
	dict['topic'] = 'detect_fire_uav3'
	dict['time'] = rospy.get_time()
	ws_lock.acquire()
	while dict['time'] in dict_msgs:
		dict['time'] += 0.01
...
def callbackdetect_fire_uav4(data):
	...
	dict_msgs[dict['time']] = data
	ws_lock.release()
pubdetect_fire_uav5 = rospy.Publisher(name = 'detect_fire_uav5_mon', data_class = Int8, latch = True, queue_size = 1000)
def callbackdetect_fire_uav5(data):
	global ws, ws_lock
	dict = message_converter.convert_ros_message_to_dictionary(data)
	dict['topic'] = 'detect_fire_uav5'
	dict['time'] = rospy.get_time()
	ws_lock.acquire()
	while dict['time'] in dict_msgs:
		dict['time'] += 0.01
...
def callbackdetect_fire_uav6(data):
	...
	dict_msgs[dict['time']] = data
	ws_lock.release()
pub_dict = { 'detect_fire_uav1' : pubdetect_fire_uav1,  'detect_fire_uav2' : pubdetect_fire_uav2,  'detect_fire_uav3' : pubdetect_fire_uav3,  'detect_fire_uav4' : pubdetect_fire_uav4,  'detect_fire_uav5' : pubdetect_fire_uav5,  'detect_fire_uav6' : pubdetect_fire_uav6}
msg_dict = { 'detect_fire_uav1' : "std_msgs/Int8",  'detect_fire_uav2' : "std_msgs/Int8",  'detect_fire_uav3' : "std_msgs/Int8",  'detect_fire_uav4' : "std_msgs/Int8",  'detect_fire_uav5' : "std_msgs/Int8",  'detect_fire_uav6' : "std_msgs/Int8"}
def monitor():
	...
	rospy.Subscriber('detect_fire_uav2', Int8, callbackdetect_fire_uav2)
	rospy.Subscriber('detect_fire_uav3', Int8, callbackdetect_fire_uav3)
	rospy.Subscriber('detect_fire_uav4', Int8, callbackdetect_fire_uav4)
	rospy.Subscriber('detect_fire_uav5', Int8, callbackdetect_fire_uav5)
...
def main(argv):
	...
	actions = {
		...
		'detect_fire_uav2' : ('filter', 0), 
		'detect_fire_uav3' : ('filter', 0), 
		'detect_fire_uav4' : ('filter', 0), 
		'detect_fire_uav5' : ('filter', 0), 
		'detect_fire_uav6' : ('filter', 0)
	}
	monitor()
