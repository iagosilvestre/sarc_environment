...
public class DemoEmbeddedAgentROS extends EmbeddedAgent {
	...
	protected void setupDevices() {
        ...
        addTopic("uav1/ground_truth", "nav_msgs/Odometry");
        addTopic("uav2/ground_truth", "nav_msgs/Odometry");
        addTopic("uav3/ground_truth", "nav_msgs/Odometry");
        addTopic("uav4/ground_truth", "nav_msgs/Odometry");
        addTopic("uav5/ground_truth", "nav_msgs/Odometry");
        addTopic("uav6/ground_truth", "nav_msgs/Odometry");
